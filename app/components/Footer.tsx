            ...
            <div className="flex flex-col lg:flex-row justify-between gap-10 lg:gap-6 xl:gap-8 items-start mb-8">
              ...
              <div className="w-full lg:flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1.8fr_1.2fr] gap-8 xl:gap-5 pt-4 lg:pt-5">
                ...
                <div className="flex flex-col">
                  ...
                  <ul className="space-y-3.5 text-xs text-[#2A231D] font-medium">
                ...
                <div className="flex flex-col relative w-full lg:max-w-[200px]">
                  ...
                  <table className="w-full text-left text-xs text-[#2A231D] font-medium border-separate border-spacing-y-2.5">
                    <tbody>
